...
from basic_operations import update_customer_credit, list_active_customers, display_all_customers
import logging
...
class BasicOperationsTest(TestCase):
    ...
    def test_add_customer(self):
        ...
        customer_3 = {'customer_id': '9860', 'name': 'Roger', 'last_name': 'Fortune',
                      'home_address': '676 Grand ave', 'phone_number': '5165946824',
                      'email_address': 'fortune_roger676@gmail.com', 'status': True,
                      'credit_limit': 750}

        add_customer(**customer_3)
    ...
    def test_display_all_customers(self):
        ...
        add_customer(**customer_1)
        add_customer(**customer_2)
        customer_list = [customer_1['last_name'] + ',' + customer_1['name'],

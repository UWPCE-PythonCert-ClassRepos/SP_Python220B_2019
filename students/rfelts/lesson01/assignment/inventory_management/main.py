...
def main_menu(user_prompt=None):
    ...
    :param user_prompt: String representing the menu item/action the user has chosen
    """
...
def get_price(item_code):
    """ Get the price of the item for the supplied item code
    :param item_code:
    """
    print("Get price")
...
def item_info():
    """ Prompts the user for an item code to find in the inventory """
    item_code = input("Enter item code: ")

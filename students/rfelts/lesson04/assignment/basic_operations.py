...
# Added function to show use of iteration
def add_customers(customers):
    """
    Add multiple customers to the DB
...
def get_active_customers():
    """
    Get the customers whose status is currently active
    :return List: The active customers
    """
    return Customer.select().where(Customer.status)
...
def list_active_customers():
    ...
    return get_active_customers().count()


# New function added to show iteration
def list_active_customer_names():
    """
    Get the names of customers whose status is currently active
    :return list: The names of active customers
    """
    LOGGER.info("Fetching the name of every active customer")
    return [f'{customer.name} {customer.last_name}' for customer in get_active_customers()]

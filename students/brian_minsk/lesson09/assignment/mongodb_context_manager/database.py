""" Code for lesson09 part 2 assignment.

Added error handling in the MongoDBConnection context manager.
"""
...
class MongoDBConnection():
    ...
    Added exception handling for pymongo.MongoClient errors. See

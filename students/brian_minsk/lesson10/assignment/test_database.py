...
class PrePopulatedTests(TestCase):
    ...
    def test_import_data_record_count(self):
        ...
        """
        counts = db.import_data("csv_files", "product.csv", "customers.csv", "rentals.csv")

        self.assertTupleEqual(counts["num_docs_by_type"], (5, 3, 10))
    ...
    def test_import_data_error_count(self):
        ...
        self.assertTupleEqual(counts["num_errors"], (0, 0, 0))
    ...
    def test_import_data_bad_data_error_count(self):
        ...
        """
        counts = db.import_data("csv_files", "product_bad.csv", "customers_bad.csv",
                                "rentals_bad.csv")

        self.assertTupleEqual(counts["num_errors"], (1, 1, 2))
...
class PostPopulatedTest(TestCase):
    ...
    def test_show_available_product(self):
        ...
        self.assertDictEqual(products["available_products"], test_dict)
    ...
    def test_show_rentals(self):
        ...
        self.assertDictEqual(rentals["customer_info"], test_dict)

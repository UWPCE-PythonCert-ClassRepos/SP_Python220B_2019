...
def setup_logger(log_level='0'):
    ...
    Keyword arguments:
    log_level - minimum level of logging message that is written to the file (see docsstring at
...
def parse_cmd_arguments():
    ...
    parser.add_argument('-d', '--debug', help='set logging level', required=False, default='0')
...
def main():
    ...
    setup_logger(args.debug)   # setup the logging level from a command line parameter

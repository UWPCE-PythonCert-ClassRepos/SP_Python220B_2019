...
def calculate_additional_fields(data):
    ...
    logging.info("Processing data.  Calculating additional fields.")
...
if __name__ == "__main__":
    ...
    INPUT = load_rentals_file(ARGS.debug, ARGS.input) # Input data
    OUTPUT = calculate_additional_fields(ARGS.debug, INPUT) # Data analysis
    save_to_json(ARGS.debug, ARGS.output, OUTPUT) # Output data

...
def main_menu(user_prompt=None):
    """Creates main menu for user input options."""
...
def add_new_item():
    """Defines new item and adds it to inventory."""
...
def item_info():
    """Prints item info from inventory."""
    ...
    if item_code in FULL_INVENTORY:
        ...
        for k, v in print_dict.items():
            print("{}:{}".format(k, v))
            # I couldn't figure out how to get pylint to ignore short var names
    else:

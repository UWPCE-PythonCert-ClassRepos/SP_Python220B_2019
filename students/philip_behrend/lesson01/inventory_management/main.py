...
import inventory_management.product_classes
#inventory_class
...
def add_new_item():
    ...
    if is_furniture.lower() == "y":
        ...
        new_item = product_classes.Furniture(item_code, item_description, \
        ...
        if is_electric_appliance.lower() == "y":
            ...
            new_item = product_classes.ElectricAppliances(item_code, \
                item_description, item_price, item_rental_price, item_brand, item_voltage)
        else:
            new_item = product_classes.Inventory(item_code, item_description, \

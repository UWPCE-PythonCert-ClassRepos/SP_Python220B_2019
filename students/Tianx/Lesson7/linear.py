        ...
        with open(customer_path, 'r', encoding='utf-8-sig') as csv_file:
            ...
            for customer in customer_reader:
                try:
                    ...
                    customer_count += 1
                    LOGGER.info(f"{customer['user_id']} has been added to the customer database")
                except FileNotFoundError:
                    LOGGER.info('File not found')
        ...
        with open(rental_path, 'r', encoding='utf-8-sig') as csv_file:
            ...
            for rental in rental_reader:
                try:
                    ...
                    rental_count += 1
                    LOGGER.info(f"{rental['product_id']} has been added to the rental database")
                except FileNotFoundError:
                    LOGGER.info('File not found')

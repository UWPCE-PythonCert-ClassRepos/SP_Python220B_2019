...
def logger_decorator(func):
    def set_logger(debug_level, *args):
...
def parse_cmd_arguments():
    ...
    parser.add_argument('-d', '--debug', help='input debug', required=True,
                        type=int)
...
if __name__ == "__main__":
    ...
    charge_data = load_rentals_file(args.debug, args.input)
    charge_data = calculate_additional_fields(args.debug, charge_data)
    save_to_json(args.debug, args.output, charge_data)

...
class TestDatabase(unittest.TestCase):
    ...
    def test_import_data(self):
        ...
        with database.DBConnection() as db:
            self.assertEqual(len(self.rental_data), db.rentals.count_documents({}), "Rental count")
            self.assertEqual(len(self.product_keys), db.products.count_documents({}), "Prod count")
            self.assertEqual(len(self.customer_keys), db.customers.count_documents({}), "Cust count")

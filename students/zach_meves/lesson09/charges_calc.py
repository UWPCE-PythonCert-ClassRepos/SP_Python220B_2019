"""
Lesson 9 - Modification of Lesson 2 code.
...
Debug statements are issued if the computation or data retrieval is
successful.
...
def conditional_log(func):
    """
    Enable conditional logging. This function should be used as a **decorator** to set the logging

...
class DatabaseTest(TestCase):
    ...
    def test_parse_file_data(self):
        pathj = r"C:\Users\pants\PycharmProjects\SP_Python220B_2019\students\tim_lurvey\lesson05\assignment\test"
        file = "test.csv"
        parsed = parsed_file_data(file, pathj)
    ...
    def test_parse_file_data_error(self):
        ...
        self.assertRaises(FileNotFoundError, parsed_file_data, file, pathj)

...
def main_menu(user_prompt=None):
    """ Main menu of the program that will cycle until user prompts to quit."""
    ...
    while user_prompt not in valid_prompts:
        options_str = ("{}" + (", {}") * (len(options) - 1)).format(*options)  # pylint: disable=unused-variable
...
def get_price(item_code: str):
    """Display the price for a matching item code
    :rtype: Int
    """
...
def add_new_item():
    """
    Add a new item to the full_inventory dictionary
    :rtype: None
    """
...
def item_info():
    """
    Prints information for mating item code input
    :rtype: None
    """
    item_code = input("Enter item code: ")

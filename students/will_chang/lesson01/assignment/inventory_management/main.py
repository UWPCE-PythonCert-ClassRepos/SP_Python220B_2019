"""Module that launches the user interface for the inventory management system"""
import sys
...
def main_menu(user_prompt=None):
    """Prompt user to select an option from a menu and returns the selected option"""
...
def get_price(item_code):
    """Return the latest market price for the given item code"""
...
def item_info():
    """Prompt user for item code and provides information"""
    item_code = input("Enter item code: ")

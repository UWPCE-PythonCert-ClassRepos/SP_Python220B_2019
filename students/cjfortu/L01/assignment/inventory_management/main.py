...
def add_new_item():
    ...
    if is_furniture.lower() == "y":
        ...
        new_item = \
        furniture_class.Furniture(item_code, item_description, item_price, item_rental_price,
        ...
        if is_electric_appliance.lower() == "y":
            ...
            new_item = \
            electric_appliances_class.ElectricAppliances(item_code, item_description, item_price,
                                                         item_rental_price, item_brand,
                                                         item_voltage)
        else:
            new_item = \
            inventory_class.Inventory(item_code, item_description, item_price, item_rental_price)

#!/usr/bin/env python
"""
Lesson 07 linear implementation, taken from Lesson 05.
...
def import_data(directory_name, product_file, customer_file, rentals_file):
    ...
    rentals_count = rentals_collection.count_documents({})

    run_time = time.process_time() - init
    LOGGER.info(f'sequential time = {run_time}')

    print('total rows/documents =', (products_count, customers_count, rentals_count), ' ',

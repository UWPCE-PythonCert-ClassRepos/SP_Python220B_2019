...
def generate_data_cust():
    ...
    with open('csvfiles/customers.csv', 'w', newline='') as csvfile:
...
def generate_data_prod():
    ...
    with open('csvfiles/products.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        for i in range(0, 1000):
...
def generate_data_rentals():
    ...
    with open('csvfiles/rentals.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        for i in range(0, 1000):

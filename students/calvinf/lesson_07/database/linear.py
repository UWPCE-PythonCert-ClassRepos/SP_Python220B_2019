...
def import_customers(input_data):
    ...
    return [(insert_count, cust_count_before, cust_count_after, elasped_time)]
...
def import_products(input_data):
    ...
    return [(insert_count, product_count_before, product_count_after, elasped_time)]
...
def import_rentals(input_data):
    ...
    return [(insert_count, rental_count_before, rental_count_after, elasped_time)]

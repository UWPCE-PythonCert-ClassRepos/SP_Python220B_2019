...
def logger_decorator(function):
    """This decorator will set the logging level of the decorated functions"""
...
def calculate_additional_fields(data):
    ...
    '''
    logging.debug("calculate_additional_fields: %s", data)
...
if __name__ == "__main__":
    ...
    RESULT = calculate_additional_fields(ARGS.debug, DATA)
    save_to_json(ARGS.debug, ARGS.output, RESULT)

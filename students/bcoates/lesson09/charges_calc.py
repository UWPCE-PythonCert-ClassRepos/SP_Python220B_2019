...
def log_this(func):
    ...
    def configure_logger(level, *args):
...
if __name__ == "__main__":
    ...
    input_data = load_rentals_file(cmd_args.debug, cmd_args.input)
    output_data = calculate_additional_fields(cmd_args.debug, input_data)
    save_to_json(cmd_args.debug, cmd_args.output, output_data)

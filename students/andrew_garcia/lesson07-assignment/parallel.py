...
if __name__ == '__main__':
    ...
    path = 'D:\\UW\\PY220\\Examples and Assignments\\lesson07\\assignment\\csv_files'
    threads = []

    threads.append(threading.Thread(target=import_products, args=(path, 'products.csv')))
    threads.append(threading.Thread(target=import_customers, args=(path, 'customers.csv')))
    threads.append(threading.Thread(target=import_rentals, args=(path, 'rentals.csv')))

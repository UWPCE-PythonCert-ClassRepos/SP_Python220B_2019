...
class TestDatabaseSetup(TestCase):
    ...
    def test_import_data_positive(self):
        ...
        test_file_errors = import_data('products.csv', 'product')
        self.assertEqual(test_file_errors[0], 0)

    def test_import_data_negative(self):
        '''Test importing three csv files that don't exist'''
        drop_collection()

        test_file_errors2 = import_data('productsv2.csv', 'product')
    ...
    def test_show_available_products(self):
        ...
        run_import('products.csv', 'customers.csv', 'rentals.csv')

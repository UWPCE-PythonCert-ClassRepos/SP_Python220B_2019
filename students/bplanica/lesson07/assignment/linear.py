...
def import_product(directory_name, product_file):
    ...
    return (processed, before, after, end - start)
...
if __name__ == '__main__':
    ...
    RESULTS = []
    RESULTS.append(import_product("./", "products.csv"))
    RESULTS.append(import_customer("./", "customers.csv"))
    RESULTS.append(import_rental("./", "rentals.csv"))

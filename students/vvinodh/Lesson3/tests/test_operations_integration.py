...
class TestOperations(unittest.TestCase):
    ...
    def test_full_integration(self):
        ...
        basic_operations.update_customer_credit('009', 30000)
        basic_operations.update_status('009', 'inactive')
        expected_customer = {'customer_id': '009', 'name': 'Blames', 'lastname': 'Gond',
                             'home_address': '123 Rainier Street', 'phone_number': '8885671003',
                             'email_address': 'gond@gond.com', 'status': 'inactive',

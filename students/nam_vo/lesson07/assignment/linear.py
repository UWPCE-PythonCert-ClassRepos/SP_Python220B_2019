...
def import_data(database, directory_name, product_file, customer_file):
    ...
    for file_name in (product_file, customer_file):
        ...
        try:
            ...
            insert_data(collector, directory_name, file_name)
...
def insert_data(collector, directory_name, file_name):
...
def main():
    ...
    records = import_data(database, 'csv_files', 'product.csv', 'customer.csv')

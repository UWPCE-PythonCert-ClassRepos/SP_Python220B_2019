...
def config_logging(log_level):
    ...
    logging_level = {0: logging.CRITICAL, 1: logging.ERROR, 2: logging.WARNING, 3: logging.DEBUG}
...
def parse_cmd_arguments():
    ...
    # Line added to turn on debugging with a parameter switch, default is Critical errors only

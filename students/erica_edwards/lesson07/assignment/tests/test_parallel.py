...
class TestDatabase(unittest.TestCase):
    ...
    def test_import_data(self):
        ...
        q = Queue()
        import_data('./assignment/tests', 'test_product', 'test_customer', 'test_rental', q)
        while not q.empty():
    ...
    def test_import_data_fail(self):
        ...
        import_data('./assignment/tests', 'test_product',
                    'test_customer_fail', 'test_rental', q)
        )
    ...
    def test_import_csv(self):
        ...
        with mongo:
            db = mongo.connection.hp_norton_prototype
            import_csv('./assignment/tests', 'test_product', db, q)
            processed, _, _, _, _ = q.get()

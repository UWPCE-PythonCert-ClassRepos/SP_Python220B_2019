...
class MongoDBConnection():
    ...
    def __init__(self, host='127.0.0.1', port=27017):
        ...
        LOGGER.info("MongoDBConnection.__init__(): Host: %s Port: %s", self.host, self.port)

    def __enter__(self):
        """Connect"""
        self.connection = MongoClient(self.host, self.port)
        LOGGER.info("MongoDBConnection.__enter__(): Databases: %s",
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        LOGGER.info("MongoDBConnection.__exit__()")

# python3 charges_calc.py -d 2 -i source.json -o out.json
...
def log_decorator(func):
    """setting up log decorator"""
    def wrapper(log_input, finputs):
        """decorator wrapper"""
        init_log(log_input)
        return func(finputs)
    return wrapper
...
if __name__ == "__main__":
    ...
    init_log(ARGS.debug)
    ODATA = load_rentals_file(ARGS.debug, ARGS.input)
    NDATA = calculate_additional_fields(ARGS.debug, ODATA)

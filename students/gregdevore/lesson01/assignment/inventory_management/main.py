"""
Module to launch user interface for inventory management system
"""
...
def main_menu(user_prompt=None):
    """
    Launch main menu for navigating inventory system
    """
...
def get_price():
    """
    Return the price for a given item code
    """
    print("Get price")
...
def item_info():
    """
    Print information for item in inventory
    """
    item_code = input("Enter item code: ")

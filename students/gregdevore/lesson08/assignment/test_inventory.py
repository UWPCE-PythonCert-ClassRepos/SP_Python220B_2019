...
class InventoryTests(TestCase):
    ...
    Methods:
        setUpClass(cls):
            Class method to run before any tests, defines csv file names, validation
            data, and writes test csv file

        tearDownClass(cls):
            Class method to run after all tests, removes csv files created during
            testing

        test_add_furniture(self):
            Method to test add_furniture method

        test_single_customer(self):

    ...
    try:
        ...
        with open(filename, 'r') as file:
            ...
            for row in csv_reader:
                # "counter" is a global variable for total number of records
                # processed by the program including the total of customers,
                # the total of products and the total of rentals.
                # All three threads will try to update this global variable
                # at the same time. This can cause the value of this variable
                # unpredictable. To sovle this problem, we have to synchronize
                # this variable by using threading.Lock().
                # The improved version of parallel with lock is written in file

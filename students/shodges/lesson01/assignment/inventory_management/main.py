...
def addNewItem():
    ...
    if isFurniture.lower() == "y":
        ...
        newItem = furniture_class.furniture(itemCode, itemDescription, itemPrice, itemRentalPrice,
        ...
        if isElectricAppliance.lower() == "y":
            ...
            newItem = electric_appliances_class.ElectricAppliances(itemCode, itemDescription,
                                                                   itemPrice, itemRentalPrice,
                                                                   itemBrand, itemVoltage)
        else:
            newItem = inventory_class.inventory(itemCode, itemDescription, itemPrice,
                                                itemRentalPrice)

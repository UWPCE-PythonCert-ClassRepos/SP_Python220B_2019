...
def timer_func(func):
    ...
    def timed_func(*args, **kwargs):
        ...
        record_count = get_database_document_count(database_name) - start_count
        with open(log_file, 'a') as write_file:
            write_file.write('Function: {}, execution time: {}, database records processed: {}\n' \
                             .format(func.__name__, run_time, record_count))
        return result
    return timed_func


def get_database_document_count(database_name):

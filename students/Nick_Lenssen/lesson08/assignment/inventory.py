"""Module will add data to a new .csv file or append an excisting one
single_customer will close and returen function customer rental
that will loop through iteams to add items to a single customer"""

...
import csv
import os
from parallel import import_csv, import_data, drop_collections, MongoDBConnection
from parallel import show_rentals, show_available_products, insert_into_table, async_import
...
class TestBasicOps(TestCase):
    ...
    def test_async_import(self):
        """test the import function for async"""
        database = database_setup()
        test = async_import(PATH, 'products.csv', 'tests')

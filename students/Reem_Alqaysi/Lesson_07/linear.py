...
def import_customers(directory_name, customer_file):
    """Brings in csv files, counts customers, products and rentals"""
...
if __name__ == '__main__':
    ...
    CUSTOMERS = import_customers('input_files', 'customers.csv')
    PRODUCTS = import_products('input_files', 'products.csv')
    RENTALS = import_rentals('input_files', 'rentals.csv')

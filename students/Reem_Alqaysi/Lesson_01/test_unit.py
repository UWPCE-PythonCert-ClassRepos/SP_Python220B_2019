...
class InventoryTests(TestCase):
    ...
    def setUp(self):
        ...
        self.test_inv = inventory_class.Inventory(self.item_code,
                                      self.description,
                                      self.market_price,
                                      self.rental_price
                                      )
    ...
    def test_inv_creation(self):
        ...
        compare_dict = {'item_code': 654,
                        'description': "table",
                        'market_price': 800,
                        'rental_price': 25
                        }
        self.assertEqual(self.item_code, 654)
        self.assertEqual(self.description, "table")
...
class FurnitureTests(TestCase):
    ...
    def setUp(self):
        ...
        material = "Fabric"
        size = "S"
        self.test_furniture_item = furniture_class.Furniture(item_code,
                                                description,
                                                market_price,
                                                rental_price,
                                                material,
    ...
    def test_furniture_creation(self):
        ...
        self.assertEqual(self.test_furniture_item.item_code, 6546)
        ...
        self.assertEqual(self.test_furniture_item.material, "Fabric")
        self.assertEqual(self.test_furniture_item.size, "S")
...
class ElectricAppliancesTests(TestCase):
    ...
    def setUp(self):
        ...
        brand = "Samsung"
        voltage = 12
        self.test_app_item = electric_appliances_class.ElectricAppliance(item_code,
                                                  description,
                                                  market_price,
                                                  rental_price,
                                                  brand,
    ...
    def test_app_creation(self):
        ...
        self.assertEqual(self.test_app_item.item_code, 65467)
        self.assertEqual(self.test_app_item.description, "TV")
...
class MainTests(TestCase):
    ...
    def test_add_new_item(self):
        ...
        furn_item = [2, 'Couch', 25, 'y', 'Fabric', 'L']
        # Item code, item desc, rental price, is it furn (y/n),
        # is it elec app (y/n), brand, voltage
        elec_item = [3, 'TV', 100, 'n', 'y', 'Samsung', 12]

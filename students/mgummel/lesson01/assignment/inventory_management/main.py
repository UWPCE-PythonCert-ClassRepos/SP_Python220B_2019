...
def main_menu(user_prompt=None):
    """
    The default selection menu presented to the user
    that will assist with taking actions in the program
    """
...
def get_price(item_code):
    """
    Retrieves the market price based on the item_code
    """
    print("Get price")
...
def item_info():
    """
    Verifies if the item information already exists
    in the inventory. If it is, it retrieves information
    of the item.
    """
    item_code = input("Enter item code: ")
...
def exit_program():
    """
    Gracefully exits the user interface menu of the program.
    """
    sys.exit()

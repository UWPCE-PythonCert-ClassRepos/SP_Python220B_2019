"""
main program to enter the inventory management software
"""
import sys
...
def main_menu(user_prompt=None):
    """
    main_menu function to ask for user input to add new inventory, get item information or quit
    """
...
def get_price(item_code):
    """
    function to return price given an item code
    """
...
def item_info():
    """
    function to prompt for a code and print its information
    """
    item_code = input("Enter item code: ")

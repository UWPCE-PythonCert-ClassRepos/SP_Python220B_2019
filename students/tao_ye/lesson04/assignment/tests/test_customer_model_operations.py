"""
    Test module for customer database using unittest package
"""
...
class OperationsTests(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """ Create database at the beginning of the tests """
    ...
    def test_add_customer(self):
        ...
        op.add_customer(new_customer[CUSTOMER_ID], new_customer[NAME], new_customer[LAST_NAME],
                        ...
                        new_customer[EMAIL_ADDRESS], new_customer[ACTIVE],
                        new_customer[CREDIT_LIMIT])

        a_customer = db.Customer.get(db.Customer.customer_id == new_customer[CUSTOMER_ID])
        db.database.close()
        ...
        # Test exception: add an duplicate customer id

...
if __name__ == '__main__':
    ...
    THREAD1 = threading.Thread(target=import_customers, args=('input_files', 'customers_l7.csv',
                                                              MY_QUEUE))
    THREAD1.start()
    THREAD2 = threading.Thread(target=import_products, args=('input_files', 'products_l7.csv',
                                                             MY_QUEUE))
    THREAD2.start()
    THREAD3 = threading.Thread(target=import_rentals, args=('input_files', 'rentals_l7.csv',
                                                            MY_QUEUE))
    THREAD3.start()

...
if __name__ == '__main__':
    import_data('input_csv', 'products_short.csv', 'customer_short.csv', 'rentals_short.csv')
    import_data('input_csv', 'products_medium.csv', 'customer_medium.csv', 'rentals_medium.csv')
    import_data('input_csv', 'products_long.csv', 'customer_long.csv', 'rentals_long.csv')
    show_available_products()
    show_rentals('product_long')

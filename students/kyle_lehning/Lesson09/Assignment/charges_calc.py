...
def use_logger(function):
    """used to create a logger decorator"""
    def init_logger(level, *args, **kwargs):
        ...
        if int(level) == 1:
            ...
            # If no level or level anything else then turn logger off
...
if __name__ == "__main__":
    ...
    DATA = load_rentals_file(ARGS.debug, ARGS.input)  # pylint: disable=E1121
    DATA = calculate_additional_fields(ARGS.debug, DATA)  # pylint: disable=E1121

...
def display_customers():
    '''
    This function shows all the information for all the customers currently in the database
    '''
    logging.debug('Attempting to diplay all customers')
    return ['Customer: ' + str(customer.customer_id) + '\n'
            'Name: ' +  customer.name + '\n' +

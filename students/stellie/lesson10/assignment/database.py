...
# Be sure to demonstrate how the timing changes with differing number of
# records (you can copy and duplicate the data provided in the lesson 5 csv
# files so you have more data to deal with. It’s easy to do that. Be sure to
# show widely different numbers of records). Make some notes on your
# conclusions.
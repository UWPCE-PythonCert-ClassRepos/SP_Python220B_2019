...
import unittest
import sys
sys.path.append('/Users/guntur/PycharmProjects/uw/p220/SP_Python220B_2019/students/g_rama/lesson03/src/')
import sqlite3
from peewee import *
...
class TestBasicOperations(unittest.TestCase):
    ...
    def test_add_customer(self):
        ...
        bo.add_customer("100", "TestFirst1", "TestLast1", "TestAddress1", "TestPhone1", "test1@test.com", "1", "1000")
        expected_data = ("100", "TestFirst1", "TestLast1", "TestAddress1", "TestPhone1", "test1@test.com", "1", "1000")
    ...
    def test_search_customer(self):
        ...
        bo.add_customer("200", "TestFirst2", "TestLast2", "TestAddress2", "TestPhone2", "test2@test.com", "1", "1000")
        print("added")
    ...
    def test_update_customer_credit(self):
        ...
        bo.add_customer("300", "TestFirst3", "TestLast3", "TestAddress3", "TestPhone3", "test3@test.com", "1", "1000")

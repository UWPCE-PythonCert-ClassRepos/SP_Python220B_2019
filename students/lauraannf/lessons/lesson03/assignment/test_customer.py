...
class BaseTestCase(unittest.TestCase):
    ...
    def test_add_customer(self):
        ...
        self.assertEqual(test_c1, 'This customer ID is already in use')
        test_c1 = add_customer(*CUSTOMERS[4])
        self.assertEqual(test_c1, 'Invalid Format')
    ...
    def test_delete_customer(self):
        ...
        self.assertEqual('No record of customer with Customer ID 00001',
                         test_c3)

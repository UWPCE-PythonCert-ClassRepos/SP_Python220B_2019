...
def import_data(directory_name, product_file, customer_file, rental_file):
    ...
    with mongo:
        ...
        customer_thread = threading.Thread(target=add_thing,
                                           args=(cust_dict_lst, customers))
        products_thread = threading.Thread(target=add_thing,
                                           args=(prod_dict_lst, products))
        rentals_thread = threading.Thread(target=add_thing, args=(rent_dict_lst, rentals))

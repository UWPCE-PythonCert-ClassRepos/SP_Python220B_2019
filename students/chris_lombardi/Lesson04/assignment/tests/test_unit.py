...
sys.path.append('C:\\Users\\chris\\documents\\PY220_Git\\SP_Python220B_2019\\'
                '\\students\\chris_lombardi\\Lesson04\\assignment')
...
class test_basic_operations(unittest.TestCase):
    ...
    def test_add_customer(self):
        ...
        self.clear_database()
        logging.debug('Testing add_customer...')
    ...
    def test_search_customer(self):
        ...
        logging.debug('Testing search_customer...')
        self.clear_database()
        basic_operations.add_customer(*self.CUST_LIST[0])
        expected_dict = {
    ...
    def test_delete_customer(self):
        ...
        logging.debug('Testing delete_customer...')
        self.clear_database()
        basic_operations.add_customer(*self.CUST_LIST[0])
        basic_operations.add_customer(*self.CUST_LIST[1])
    ...
    def test_update_customer_credit(self):
        ...
        logging.debug('Testing update_customer_credit...')
        self.clear_database()
        basic_operations.add_customer(*self.CUST_LIST[2])
        new_credit = 505050
    ...
    def test_list_active_customers(self):
        ...
        logging.debug('Testing list_active_customer...')

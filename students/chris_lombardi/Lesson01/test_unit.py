...
class TestInventoryClass(TestCase):
    ...
    def test_inventory(self):
        ...
        test_inv_obj = {'product_code': '001',
                        'description': 'Brush',
                        'market_price': 20.0,
                        'rental_price': 5.0}
        item_details = ('001', 'Brush', 20.0, 5.0)
...
class TestFurnitureClass(TestCase):
    ...
    def test_furniture(self):
        ...
        furn_obj = {'product_code': '003',
                    'description': 'Desk',
                    'market_price': 150.0,
                    'rental_price': 10.0,
                    'material': 'Bamboo',
                    'size': 'M'}
        item_details = ('003', 'Desk', 150.0, 10.0, 'Bamboo', 'M')

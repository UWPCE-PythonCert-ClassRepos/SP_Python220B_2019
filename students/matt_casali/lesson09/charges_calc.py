...
# pylint: disable= W0621, C0103, E1121


def add_logging(function):
    """ Create a decorator to enable logging if debug arg passed """
    def logger_setup(level, *args):
...
if __name__ == "__main__":
    ...
    data_json = load_rentals_file(args.debug, args.input)
    data_final = calculate_additional_fields(args.debug, data_json)
    save_to_json(args.debug, args.output, data_final)

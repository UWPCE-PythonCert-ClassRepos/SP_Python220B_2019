...
def logging_level(func):
    """ Set Logging Level Decorator
...
if __name__ == "__main__":
    ...
    # set_logging_level(ARGS.debug)02
    RENTAL_DATA = load_rentals_file(ARGS.debug, ARGS.input)
    RENTAL_DATA = calculate_additional_fields(ARGS.debug, RENTAL_DATA)
    save_to_json(ARGS.debug, ARGS.output, RENTAL_DATA)

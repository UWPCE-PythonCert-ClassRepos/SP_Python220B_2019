...
class MongoDBConnection:
    ...
    def __enter__(self):
        ...
        # Add collections to database class
...
def import_data(directory_name, product_file, customer_file, rentals_file):
    ...
    with hpn_db:
        for idx, collection in enumerate(collections):
            ...
            [r_cnt, e_cnt] = populate_database(hpn_db.database, collection, data)
...
def show_available_products():
    ...
    hpn_db = MongoDBConnection()
    with hpn_db:
        products = [x for x in hpn_db.products.find()]
...
if __name__ == "__main__":
    ...
    [RECORDS, ERRORS] = import_data(D_NAME, P_FILE, C_FILE, R_FILE)

...
class CustomerTest(TestCase):
    ...
    def test_search_customer_exists(self):
        ...
        LOGGER.info("*** TEST ***:search_customer for existing customer")
        # Given
        expected_customer = {
            "name": "Sally",
            "last_name": "Ride",
    ...
    def test_search_customer_does_not_exist(self):
        ...
        LOGGER.info("*** TEST ***:search_customer for non-existing customer")
        # Given
        expected_customer = {}
    ...
    def test_delete_customer_exists(self):
        ...
        LOGGER.info("*** TEST ***:delete_customer for existing customer")
        # Given
        expected_customer = {
            "name": CUSTOMER1[1],
    ...
    def test_update_customer_credit(self):
        ...
        LOGGER.info("*** TEST ***:update_customer_credit for existing customer")
        # Given
        new_credit = 333.33
    ...
    def test_update_customer_credit_bad_id(self):
        ...
        LOGGER.info("*** TEST ***:update_customer_credit for non-existing customer")
        # Given
        new_credit = 3.95
    ...
    def test_list_active_emails(self):
        ...
        # When
        expected_emails_list = ["sally.ride@shuttle.org", "buzzaldrin@apollo11.com"]
